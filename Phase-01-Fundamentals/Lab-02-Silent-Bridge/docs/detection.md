# Detection — Lab-02 Silent Bridge

> **Capability:** acceso vía exploit web → pivoting (tunneling) → session passing / relay C2.
> **Operación:** SILENT BRIDGE · **Adversario:** APT41 · **Perspectiva:** Blue Team / Purple.
...
> texto de las reglas. Aquí, la detección **específica de esta operación**, por vector explotado.
...
Toda la detección anterior asume **defensas activas y sin evadir** — la pasada "off". Cada vector tiene su evasión,
que se practica en los labs de Phase-03:

| Detección de este lab | Cómo se evade | Se trata en |
|-----------------------|---------------|-------------|
| Webmin RCE en logs de acceso | Exploit sobre CVE menos monitorizada; limpiar logs del servicio | Lab-11 |
| Túnel Ligolo por patrón de tráfico | Mimetizar con HTTPS legítimo, throttling del túnel | Lab-08/11 |
| WinRM lateral (4624 tipo 3) | Credenciales válidas en ventana horaria esperable | Lab-11 |
| Defender deshabilitado (5001) | No tocarlo: AMSI/ETW bypass en memoria | Lab-11 (Defender/AMSI) |
| Beacon relay periódico | Malleable C2, jitter alto, perfil legítimo | Lab-08/11 |

> Materializa el modelo "off, then on" del `LEARNING_PATH.md`: aquí la técnica con la defensa despierta; allí,
> cómo operarla sin que te vea.

---

## Resumen de superficie de ataque — SILENT BRIDGE
...
*Detection · Lab-02 Silent Bridge · hereda de DETECTION_LIBRARY.md (anatomía v3.1)*
