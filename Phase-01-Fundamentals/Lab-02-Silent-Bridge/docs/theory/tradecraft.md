# Tradecraft — Operación SILENT BRIDGE
## Lab-02: Pivoting, Exploits Web y Movimiento Lateral en Redes Segmentadas

**Operación:** SILENT BRIDGE | **Adversario:** APT41 | **Nivel:** Fundamentals  
...
1. [Segmentación de red — Por qué existe y cómo se supera](#1-segmentación-de-red)
2. [CVE-2019-12840 — Webmin RCE autenticado](#2-cve-2019-12840)
3. [Tunneling con Ligolo-ng — Teoría y arquitectura](#3-tunneling-con-ligolo-ng)
4. [Git history — Credenciales en control de versiones](#4-git-history)
5. [WinRM — Windows Remote Management como vector](#5-winrm)
6. [Relay C2 — Beacon en redes no accesibles directamente](#6-relay-c2)
7. [Credential Reuse — Reutilización de contraseñas](#7-credential-reuse)
8. [OPSEC en entornos segmentados](#8-opsec-en-entornos-segmentados)
...
## 8. OPSEC en entornos segmentados
