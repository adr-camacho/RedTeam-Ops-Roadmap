...
- `docs/DESIGN.md` v2.1 — infraestructura multi-forest, fixes, lecciones
- `docs/PROGRESS.md` — Sesión 18 añadida
...
- `docs/CHANGELOG.md`, `docs/OPSEC_NOTES.md`, `docs/DETECTION_LIBRARY.md`
