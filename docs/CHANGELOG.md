...
### ADD
- `Lab-03-Gatekeeper/docs/infrastructure_setup.md` — ADCS setup + ESC1/ESC4/ESC8 con comandos reales
- `Lab-03-Gatekeeper/docs/enumeration_log.md` — Certipy find, ESC1/ESC8 identificados
- `Lab-03-Gatekeeper/docs/exploitation_esc1.md` — kill chain ESC1, hashes reales
- `Lab-03-Gatekeeper/docs/exploitation_esc4.md` — fin.garcia → plantilla modificada → DA
- `Lab-03-Gatekeeper/docs/exploitation_esc8.md` — relay identificado, KB5005413 documentado
- `Lab-03-Gatekeeper/docs/c2_sliver.md` — CLINICAL_CHAIRMAN, 3 beacons simultáneos
- `Lab-03-Gatekeeper/docs/persistence.md` — cert persistence post-rotación + kill chain completo
- `Lab-03-Gatekeeper/docs/lessons_learned.md` — 10 lecciones + tabla ESC1-ESC11
- `Lab-03-Gatekeeper/docs/mitigations.md` — mitigaciones + reglas SIGMA + CRL/OCSP
- `Lab-03-Gatekeeper/setup/Setup-Lab03-DarkGate.ps1` — script setup ADCS 4 bloques
- `Lab-03-Gatekeeper/screenshots/` — fases 1-6 con capturas reales
...
- `Lab-03-Gatekeeper/OPERATION_DARK_GATE.md` — plan actualizado con datos reales
- `Lab-03-Gatekeeper/README.md` — badges, attack path, stack tecnológico real
...
### ADD
- `Lab-03-Gatekeeper/OPERATION_DARK_GATE.md` — plan operación APT29 ADCS (movido desde Phase-01 raíz)
- `Lab-03-Gatekeeper/README.md` — índice con vectores ESC1/ESC4/ESC8

### FIX
- `OPERATION_DARK_GATE.md` movido a `Lab-03-Gatekeeper/` (estaba en Phase-01 raíz)
...
### ADD
- `Lab-02-Wreath/docs/post-exploitation.md` — Fase 5: lateral movement PC-01
- `Lab-02-Wreath/docs/c2_sliver.md` — Fase 6: beacon SUDDEN_COMMUNICATION relay PROD
- `Lab-02-Wreath/docs/persistence.md` — Fase 7: schtasks + Run Key + SAM dump
- `Lab-02-Wreath/docs/lessons_learned.md` — 14 lecciones, comparativa Lab-01 vs Lab-02
- `Lab-02-Wreath/docs/mitigations.md` — mitigaciones + reglas SIGMA
...
### ADD
- `Lab-02-Wreath/docs/enumeration_log.md` — Fases 1 y 4
- `Lab-02-Wreath/docs/exploitation.md` — CVE-2019-12840, exploit Python desde 46984.rb
- `Lab-02-Wreath/docs/pivoting.md` — Ligolo-ng v0.7.5
...
### ADD
- `Lab-02-Wreath/` — estructura completa + OPERATION_SILENT_BRIDGE.md
