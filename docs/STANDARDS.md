# 📐 STANDARDS.md — Estándar del producto
...
>
> Ubicación: `docs/STANDARDS.md` · Versión: 1.0 · Fecha: 18/06/2026
...
1. **Plan canónico:** Roadmap v3.0 (18 labs) es el plan. `docs/ROADMAP.md` es la única fuente de verdad.
